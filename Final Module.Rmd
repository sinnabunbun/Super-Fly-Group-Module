...
There are several different ways to estimate phylogenies, each with their own strengths, weaknesses, and appropriate situations in which to apply them. While we won’t go over them in detail, familiarize yourselves by looking at [Module 24](https://fuzzyatelin.github.io/bioanth-stats/module-24/module-24.html)  
...
_Types of tree formats: Newick, NEXUS_  
...
1. __Load the tree files into R__ 
