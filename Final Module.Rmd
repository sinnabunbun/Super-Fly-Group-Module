...
![image](https://raw.githubusercontent.com/sinnabunbun/Super-Fly-Group-Module/main/Screen%20Shot%202021-12-03%20at%207.19.20%20AM.png)
###SOLUTION 1 
...
![image](https://raw.githubusercontent.com/sinnabunbun/Super-Fly-Group-Module/main/Screen%20Shot%202021-12-03%20at%207.25.00%20AM.png)
...
```{r}
ggtree(mol.tree, aes(color=rate)) +
    scale_color_continuous(low='darkgreen', high='red') +
    theme(legend.position="right")
```

```{r}
g <- ggtree(morph.tree, color="steelblue", size=0.5, linetype="dotted")
g <- g + geom_tiplab(size=2)
g
```
