...
```{r}
p<- ggplot(mol.tree) + geom_tree() + theme_tree() + geom_tiplab()
...
morphotree <- plot(morph_tree_3, "phylogram", main="morph_tree_3")
morphotree
...
```{r}
class(morph_tree_3)
morph.tree.phylo <- as.phylo.phylog(morph_tree_3)
morph.tree.phylo

as.phylo.phylog(morph_tree_3)
as.multiPhylo.list(morph_tree_3)
```
